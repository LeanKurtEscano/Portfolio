    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 items-center min-h-[80vh] max-w-6xl mx-auto">
          {/* Text Content */}
          <div
            className={`space-y-8 text-center lg:text-left order-2 lg:order-1 transition-all duration-1000 ease-out ${isVisible
          ...
          >
            <div className="space-y-6">
              <div
                className={`inline-block transition-all duration-700 delay-200 ease-out ${isVisible
              ...
              <h1
                className={`text-4xl md:text-5xl xl:text-6xl font-bold leading-tight transition-all duration-1000 delay-300 ease-out ${isVisible
              ...
              <p
                className={`text-lg md:text-xl text-gray-300 leading-relaxed transition-all duration-1000 delay-500 ease-out ${isVisible
                    ? 'opacity-100 translate-y-0'
            ...
            {/* CTA Buttons */}
            <div
              className={`flex flex-col sm:flex-row gap-4 justify-center lg:justify-start transition-all duration-1000 delay-700 ease-out ${isVisible
                  ? 'opacity-100 translate-y-0'
                  : 'opacity-0 translate-y-8'
                }`}
            >
            ...
            {/* Social Links */}
            <div
              className={`flex gap-6 justify-center lg:justify-start transition-all duration-1000 delay-900 ease-out ${isVisible
                  ? 'opacity-100 translate-y-0'
                  : 'opacity-0 translate-y-6'
                }`}
            >
              {[
                ...
                index === 2 ? (
                  <button
                    ...
                    className={`p-3 rounded-full border border-gray-700 text-gray-400 hover:text-white hover:border-purple-500 hover:bg-purple-500/10 transition-all duration-300 hover:scale-110 hover:rotate-12 ${isVisible ? 'animate-fade-in-up' : ''
                      }`}
          ...
          {/* Image Container */}
          <div
            className={`flex justify-center lg:justify-end order-1 lg:order-2 transition-all duration-1000 delay-400 ease-out ${isVisible
          ...
          >
            <div className="relative pb-5 w-full max-w-sm lg:max-w-md">
              ...
              {/* Floating Elements */}
              <div
                className={`absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-purple-500 to-cyan-500 rounded-full opacity-20 animate-pulse transition-all duration-1000 delay-600 ${isVisible
                    ? 'scale-100 opacity-20'
                    : 'scale-0 opacity-0'
                  }`}
              ></div>
              <div
                className={`absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-cyan-500 to-green-500 rounded-full opacity-20 animate-pulse delay-1000 transition-all duration-1000 delay-800 ${isVisible
                    ? 'scale-100 opacity-20'
                    : 'scale-0 opacity-0'
                  }`}
              ></div>
      ...
      {/* Scroll Indicator */}
      <div
        className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10 transition-all duration-1000 delay-1100 ease-out ${isVisible
            ? 'opacity-100 translate-y-0'
